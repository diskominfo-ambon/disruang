...
app.component('room-schedule-form', (0,vue__WEBPACK_IMPORTED_MODULE_0__.defineAsyncComponent)(function () {
  return Promise.resolve().then(function webpackMissingModule() { var e = new Error("Cannot find module '~vendor/contents/room-schedule-form'"); e.code = 'MODULE_NOT_FOUND'; throw e; });
}));
app.component('datetime-picker-input', (0,vue__WEBPACK_IMPORTED_MODULE_0__.defineAsyncComponent)(function () {
  return Promise.resolve().then(function webpackMissingModule() { var e = new Error("Cannot find module '~vendor/components/datetime-picker-input'"); e.code = 'MODULE_NOT_FOUND'; throw e; });
}));
