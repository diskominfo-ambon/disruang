                    ...
                    <div class="nk-sidebar-content">
                        ...
                        <div class="nk-sidebar-menu">
                            ...
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-item">
                                    <a href="{{ route('admin.submissions') }}" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-repeat"></em></span>
                                        <span class="nk-menu-text">Permohonan</span>
                                    </a>
                                </li>
                                <li class="nk-menu-item">
                                  <a href="{{ route('admin.schedules.index') }}" class="nk-menu-link">
                                ...
                                <li class="nk-menu-item">
                                  <a href="{{ route('admin.d.index') }}" class="nk-menu-link">
                                      ...
                                      <span class="nk-menu-text">Administrator pengguna</span>
                                  </a>
                                </li>
                                <li class="nk-menu-item">
